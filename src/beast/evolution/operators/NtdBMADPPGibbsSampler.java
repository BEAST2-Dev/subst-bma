    ...
    public double proposal(){
        ...
        try{
            ...
            for(i = 0; i < counter; i++){
                ...
                if(temp1 != temp2){
                    System.out.println(existingParamVals[i].getIDNumber());
                    System.out.println(existingModelVals[i].getIDNumber());
                    System.out.println(existingFreqsVals[i].getIDNumber());
