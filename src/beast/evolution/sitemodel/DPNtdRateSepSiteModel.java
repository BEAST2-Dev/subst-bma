...
public class DPNtdRateSepSiteModel extends DPSingleAlignSiteModel {
    ...
    DPNtdBMA dpNtdBMA;
    DPPointer ratesPointers;
    ParameterList ratesList;
    ...
    int[][] storedSiteModelWeights;
    //private int[] substWeights;
    //private int[] ratesWeights;
    int[][] clusterMap;
    int[][] storedClusterMap;
    DPValuable dpValSubst;
    DPValuable dpValRate;
    ...
    public void updateWeights(int siteIndex, int ntdBMACluster, int rateCluster){
        mappingChanged = true;
